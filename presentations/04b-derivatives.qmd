...
![](./images/04-derivatives/implicit-curve.png){fig-align="center"}
...
fig, (ax0, ax1, ax2) = plt.subplots(nrows=3, figsize=(5, 6))
t = np.linspace(0, 5)
x = 2*t**3 - 15*t**2 + 24*t
v = 6*t**2 - 30*t + 24
a = 12*t - 30
...
![](./images/04-derivatives/nixon.jpeg){fig-align="center"}
