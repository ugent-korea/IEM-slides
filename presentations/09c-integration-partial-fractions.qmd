...
\begin{align*}
    \int \frac{x+2}{x^3-x} dx & = - 2\int \frac{dx}{x} + \frac{3}{2} \int \frac{dx}{x-1} dx + \frac{1}{2} \int \frac{dx}{x + 1} dx \\
...
- For each quadratic factor, put a *linear term* in the denominator of the partial fraction.
...
2. Factor the denominator $Q(x)$:
   - All distinct roots:
     $$
        \frac{P(x)}{Q(x)} = \cdots + \frac{A_1}{x - \alpha_1} + \cdots + \frac{A_k}{x - \alpha_k}.
     $$
   - Irreducible quadratic factors:
     $$
        \frac{P(x)}{Q(x)} = \cdots + \frac{Ax+B}{x^2 + \cdots}
     $$
   - Repeated linear factors:
     $$
        \frac{P(x)}{Q(x)} = \cdots + \frac{A_1}{x - \alpha} + \cdots + \frac{A_p}{(x - \alpha)^p}
     $$
     
These three cases can happen at the same time!!
