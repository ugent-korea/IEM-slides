...
![](./images/07-binomial/Yanghui_triangle.png){fig-align="center"}

Figure credit: https://en.wikipedia.org/wiki/Jia_Xian
...
2. $\displaystyle {n \choose 1} = {n \choose n - 1} = n$.
3. $\displaystyle {n \choose k} = {n \choose n - k}$.
