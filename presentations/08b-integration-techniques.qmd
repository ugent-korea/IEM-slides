...
Let $\displaystyle I_n = \int_0^1 \frac{x^n}{\sqrt{1+x^2}} \,\mathrm{d}x$. Show that 
$\displaystyle n I_n = \sqrt{2} - (n - 1) I_{n-2}$.

### Example

Find the value of $\displaystyle \int_0^1 \frac{x^3}{\sqrt{1 + x^2}} \,\mathrm{d}x$.
