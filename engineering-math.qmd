...
![The graph of the inverse sine function. The domain is $[-1, 1]$ and the range is $[-\pi/2, \pi/2]$.](./images/01-trigonometry/inverse-sine-flipped.png)
...
![The graph of the inverse cosine function. The domain is $[-1, 1]$ and the range is $[0, \pi]$.](./images/01-trigonometry/inverse-cosine-flipped.png)
...
![The graph of the inverse tangent function. The domain is the entire $x$-axis and the range is $[-\pi/2, \pi/2]$.](./images/01-trigonometry/inverse-tangent-flipped.png)
...
so that
$$
    y = \cos \alpha = \frac{\pm 1}{\sqrt{1 + \tan^2 \alpha}} = \frac{\pm 1}{\sqrt{1 + x^2}}.
$$
